...
tf.app.flags.DEFINE_string('videos_directory', '../../UCF-101/', 'Video data directory')
tf.app.flags.DEFINE_string('annotation_directory', '../../UCF101_24Action_Detection_Annotations/', 'Video annotation directory')
tf.app.flags.DEFINE_string('input_file', '../dataset/reduced_vallist.txt', 'Text file with (filename, label) pairs')
...
tf.app.flags.DEFINE_string('name', 'UCF-24-reduced_val', 'Name for the subset')
