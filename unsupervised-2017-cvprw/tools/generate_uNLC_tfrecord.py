...
sys.path.append('/imatge/carenas/research/uNLC/src')
import run_full_uNLC as uNLC

tf.app.flags.DEFINE_string('videos_directory', '../../UCF-101/', 'Video data directory')
tf.app.flags.DEFINE_string('input_file', '../dataset/train_list.txt', 'Text file with (filename, label) pairs')
tf.app.flags.DEFINE_string('output_directory', '../dataset/UCF-101-uNLC-tf-records', 'Output data directory')
