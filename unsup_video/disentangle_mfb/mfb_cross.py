...
subversion = 0
if FLAGS.feat == 1 and FLAGS.diff_dec == 0: subversion = 1
elif FLAGS.feat == 0 and FLAGS.diff_dec == 1: subversion = 2
...
evaluation_job  = './jobs/mfb_cross' + (str(FLAGS.version) if FLAGS.version != 1 else '') + (str(subversion) if subversion != 0 else '') + '_val'
